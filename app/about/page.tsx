...
export default function About() {
    return (
        <div className="min-h-screen bg-[url('/background-test.jpg')] bg-cover bg-center bg-no-repeat bg-fixed text-white overflow-x-hidden font-sans">
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 pt-6 pb-20">
                ...
                {/* Back Button */}
                <div className="mb-8">
                    <Link href="/" className="inline-flex items-center px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/10 rounded-full text-sm font-medium text-white transition-all">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                            Our Mission: <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-pink-300">Connecting Every Voice</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 hover:bg-white/15 transition-all duration-300 flex flex-col justify-between">
                        <div>
                    ...
                    <div className="md:col-span-7 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 hover:bg-white/15 transition-all duration-300">
                        <h2 className="text-2xl font-bold mb-8">Introducing Seamless Interaction</h2>

                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            {/* Feature 1 */}
                            <div className="text-center">
                                <div className="w-16 h-16 mx-auto bg-blue-500/20 rounded-full flex items-center justify-center mb-4 text-blue-300">
                                ...
                                <h3 className="font-bold text-sm mb-2">Real-Time Translation</h3>
                                <p className="text-xs text-gray-300">Instantly convert speech to text and sign breaking down communication barriers.</p>
                            </div>

                            {/* Feature 2 */}
                            <div className="text-center">
                                <div className="w-16 h-16 mx-auto bg-purple-500/20 rounded-full flex items-center justify-center mb-4 text-purple-300">
                                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                                </div>
                                <h3 className="font-bold text-sm mb-2">Accessible Conversations</h3>
                                <p className="text-xs text-gray-300">Seamlessly convert in any situation for instant language changes and clarity.</p>
                            </div>

                            {/* Feature 3 */}
                            <div className="text-center">
                                <div className="w-16 h-16 mx-auto bg-pink-500/20 rounded-full flex items-center justify-center mb-4 text-pink-300">
                                ...
                                <h3 className="font-bold text-sm mb-2">Accessibility & Inclusion</h3>
                                <p className="text-xs text-gray-300">Engage freely beyond borders and finding our us in daily life.</p>
                            </div>
                        </div>
                    </div>

                    {/* Our Solution (Medium Box Left) */}
                    <div className="md:col-span-6 lg:col-span-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 hover:bg-white/15 transition-all duration-300 flex flex-col-reverse md:flex-col">
                    ...
                    <div className="md:col-span-6 lg:col-span-7 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 hover:bg-white/15 transition-all duration-300">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center h-full">
                            <div>
                                <h2 className="text-2xl font-bold mb-2">Our Story</h2>
                                <h3 className="text-lg font-semibold text-purple-200 mb-4">The Minds Behind Voiceless</h3>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <span className="text-[10px] block opacity-70">Fame True Nocoe</span>
                                    </div>
                                    <div className="text-center">
                                        <div className="w-10 h-10 rounded-full bg-purple-300/20 mx-auto mb-1"></div>
                                        <span className="text-[10px] block opacity-70">Des whil of Twaiver</span>
                                    </div>
                                </div>
                            </div>
