        ...
        <div className="min-h-screen bg-[url('/background-test.jpg')] bg-cover bg-center bg-no-repeat bg-fixed text-white overflow-x-hidden">
            ...
            <nav className="relative z-10 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-200">
                    ...
                    <Link href="/features" className="text-white font-bold transition-colors">Features</Link>
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-10">
                ...
                <div className="w-full">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {/* Feature 1 */}
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold mb-2">Real-Time Voice-to-Text</h3>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold mb-2">Accessible Conversations</h3>
                            <p className="text-sm text-gray-400">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold mb-2">Sign Language Recognition</h3>
                            <p className="text-sm text-gray-400">
                        ...
                        {/* Feature 4 */}
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1">
                            <div className="w-12 h-12 bg-yellow-500/20 rounded-xl flex items-center justify-center mb-4 text-yellow-300">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" /></svg>
                            </div>
                            <h3 className="text-lg font-bold mb-2">Customizable Profiles</h3>
                            <p className="text-sm text-gray-400">
                        ...
                        {/* Feature 5 */}
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1">
                            <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center mb-4 text-red-300">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                            </div>
                            <h3 className="text-lg font-bold mb-2">Offline Mode & History</h3>
                            <p className="text-sm text-gray-400">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all hover:-translate-y-1 opacity-80 border-dashed">
                            <div className="w-12 h-12 bg-gray-500/20 rounded-xl flex items-center justify-center mb-4 text-gray-300">
