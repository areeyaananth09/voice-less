            ...
            <main className="relative z-0 max-w-7xl mx-auto px-6 pt-10 pb-24">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center min-h-[60vh]">
                    <div className="space-y-6">
                        <h1 className="text-4xl md:text-5xl font-bold leading-tight drop-shadow-sm dark:drop-shadow-lg">
                            {t("voiceless")}: <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-300 dark:to-pink-300">{t("connect")}</span> <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-300 dark:to-pink-300">{t("communicate")}</span> <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-300 dark:to-pink-300">{t("empower")}</span>
                        </h1>
                ...
                <div id="how-it-works" className="grid md:grid-cols-3 gap-8 mt-20">
                    ...
                    <div className="bg-white dark:bg-white/10 backdrop-blur-md border border-gray-200 dark:border-white/20 p-8 rounded-3xl shadow-lg dark:shadow-none hover:bg-gray-50 dark:hover:bg-white/15 transition-all duration-300 group">
                        ...
                        <h3 className="text-xl font-bold mb-3">{t("realTimeTranslation")}</h3>
                    ...
                    <div className="bg-white dark:bg-white/10 backdrop-blur-md border border-gray-200 dark:border-white/20 p-8 rounded-3xl shadow-lg dark:shadow-none hover:bg-gray-50 dark:hover:bg-white/15 transition-all duration-300 group">
                        ...
                        <h3 className="text-xl font-bold mb-3">{t("accessibleConversations")}</h3>
                        <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                            {t("accessibleDesc")}
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-white/10 backdrop-blur-md border border-gray-200 dark:border-white/20 p-8 rounded-3xl shadow-lg dark:shadow-none hover:bg-gray-50 dark:hover:bg-white/15 transition-all duration-300 group">
                        ...
                        <h3 className="text-xl font-bold mb-3">{t("empoweringConnection")}</h3>
                        <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                            {t("empoweringDesc")}
                        </p>
                    </div>
