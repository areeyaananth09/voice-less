            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 pt-6 pb-24">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                            {t("ourMission")} <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-300 dark:to-pink-300">{t("connectingEveryVoice")}</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-5 bg-white/60 dark:bg-white/10 backdrop-blur-md border border-white/40 dark:border-white/20 rounded-3xl p-8 hover:bg-white/80 dark:hover:bg-white/15 transition-all duration-300 flex flex-col justify-between shadow-sm dark:shadow-none">
                        <div>
                            <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">{t("theProblem")}</h2>
                    ...
                    <div className="md:col-span-7 bg-white/60 dark:bg-white/10 backdrop-blur-md border border-white/40 dark:border-white/20 rounded-3xl p-8 hover:bg-white/80 dark:hover:bg-white/15 transition-all duration-300 shadow-sm dark:shadow-none">
                        <h2 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white">{t("seamlessInteraction")}</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="font-bold text-sm mb-2 text-gray-900 dark:text-white">{t("realTimeTranslationTitle")}</h3>
                                <p className="text-xs text-gray-700 dark:text-gray-300">{t("realTimeTranslationDesc")}</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="font-bold text-sm mb-2 text-gray-900 dark:text-white">{t("accessibleConversationsTitle")}</h3>
                                <p className="text-xs text-gray-700 dark:text-gray-300">{t("accessibleConversationsDesc")}</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="font-bold text-sm mb-2 text-gray-900 dark:text-white">{t("accessibilityInclusion")}</h3>
                                <p className="text-xs text-gray-700 dark:text-gray-300">{t("accessibilityInclusionDesc")}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-6 lg:col-span-5 bg-white/60 dark:bg-white/10 backdrop-blur-md border border-white/40 dark:border-white/20 rounded-3xl p-8 hover:bg-white/80 dark:hover:bg-white/15 transition-all duration-300 flex flex-col-reverse md:flex-col shadow-sm dark:shadow-none">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">{t("ourSolution")}</h2>
                    ...
                    <div className="md:col-span-6 lg:col-span-7 bg-white/60 dark:bg-white/10 backdrop-blur-md border border-white/40 dark:border-white/20 rounded-3xl p-8 hover:bg-white/80 dark:hover:bg-white/15 transition-all duration-300 shadow-sm dark:shadow-none">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center h-full">
                            <div>
                                <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">{t("ourStory")}</h2>
                                <h3 className="text-lg font-semibold text-purple-700 dark:text-purple-200 mb-4">{t("mindsBehind")}</h3>
