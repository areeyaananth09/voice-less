    ...
    <div className="min-h-screen bg-[url('/background-test.jpg')] bg-cover bg-center bg-no-repeat bg-fixed text-white font-sans overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-10 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center min-h-[60vh]">
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl font-bold leading-tight drop-shadow-lg">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-pink-300">Empower.</span>
            </h1>
            ...
            <div className="pt-4">
              <Link
                href="/login"
                className="inline-block px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold rounded-full text-lg shadow-lg hover:shadow-purple-500/40 transition-all transform hover:-translate-y-1"
              >
                GET STARTED
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            {/* Decorative floating elements if needed, can be CSS blobs */}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          {/* Card 1 */}
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl hover:bg-white/15 transition-all duration-300 group">
            <div className="w-14 h-14 bg-blue-500/20 rounded-2xl flex items-center justify-center mb-6 text-blue-300 group-hover:scale-110 transition-transform">
          ...
          {/* Card 2 */}
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl hover:bg-white/15 transition-all duration-300 group">
            <div className="w-14 h-14 bg-purple-500/20 rounded-2xl flex items-center justify-center mb-6 text-purple-300 group-hover:scale-110 transition-transform">
          ...
          {/* Card 3 */}
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl hover:bg-white/15 transition-all duration-300 group">
            <div className="w-14 h-14 bg-pink-500/20 rounded-2xl flex items-center justify-center mb-6 text-pink-300 group-hover:scale-110 transition-transform">
